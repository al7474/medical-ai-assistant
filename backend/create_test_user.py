    ...
    async with SessionLocal() as db:
        try:
            ...
            medical_profile = MedicalProfile(
                ...
                # Chronic Conditions (JSON list)
                chronic_conditions=["Type 2 Diabetes Mellitus (diagnosed 2018, well-controlled)", "Hypertension Stage 1 (mild, controlled)"],
                
                # Current Medications (JSON list of objects)
                current_medications=[
                    {"name": "Metformin", "dosage": "850mg", "frequency": "2 times daily with meals", "purpose": "diabetes"},
                    {"name": "Lisinopril", "dosage": "10mg", "frequency": "1 time daily in morning", "purpose": "blood pressure"},
                    {"name": "Atorvastatin", "dosage": "20mg", "frequency": "1 time daily at bedtime", "purpose": "cholesterol"},
                    {"name": "Aspirin", "dosage": "81mg", "frequency": "1 time daily", "purpose": "cardiovascular protection"}
                ],
                
                # Past Surgeries (JSON list of objects)
                past_surgeries=[
                    {"name": "Appendectomy", "date": "2005"},
                    {"name": "Inguinal hernia repair", "date": "2015"}
                ],
                
                # Family History (JSON dict)
                family_history={
                    "diabetes": ["father"],
                    "hypertension": ["father", "mother"],
                    "notes": "Father died at 68 (heart attack). Mother alive at 72. Brother has pre-diabetes."
                },
...
Exercises regularly (walking, light cardio). Diet: Low carb, Mediterranean style.
            ...
            documents = [
                {
                    "filename": "lab_results_2024_01.pdf",
...
Continue current medications.
                    """.strip(),
                    "description": "Laboratory results - Metabolic panel and kidney function tests"
                },
                {
                    "filename": "blood_pressure_log_2024.pdf",
                    "content_type": "application/pdf",
                    "content": """
...
Continue current regimen.
                ...
                {
                    "filename": "diabetes_education_materials.pdf",
                    "content_type": "application/pdf",
                    "content": """
...
Phone: (555) 123-4567
            ...
            for doc_data in documents:
                doc = MedicalDocument(
                    user_id=user_id,
                    title=doc_data.get("description", "Medical Document"),
                    file_name=doc_data["filename"],
                    file_path=f"/uploads/test_user/{doc_data['filename']}",
                    mime_type=doc_data["content_type"],
                    document_type=DocumentType.LAB_RESULT if "lab" in doc_data["filename"].lower() else DocumentType.MEDICAL_REPORT,
            ...
            print("   - Schedule an appointment with Dr. González")
            ...
            print("   - POST /agent/test-tool/get_upcoming_appointments")
